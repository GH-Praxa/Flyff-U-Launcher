            ...
            try {
                ...
                for (const plugin of plugins) {
                    ...
                    if (plugin.description) {
                        const desc = el("div", "pluginDescription muted", plugin.description);
                    ...
                    if (plugin.hasSettingsUI && plugin.permissions?.includes("settings:ui") && plugin.enabled) {
                        const uiBtn = el("button", "btn pluginBtn", "UI öffnen");
                    ...
                    if (plugin.enabled) {
                        ...
                        disableBtn.addEventListener("click", async () => {
                            ...
                            if (result.success) {
                                showToast(`Plugin "${plugin.name}" deaktiviert`, "success");
                                loadPluginsList();
                            } else {
                        ...
                        enableBtn.addEventListener("click", async () => {
                            ...
                            if (result.success) {
                                showToast(`Plugin "${plugin.name}" aktiviert`, "success");
                                loadPluginsList();
                            } else {
                                showToast(result.error || "Fehler", "error");
