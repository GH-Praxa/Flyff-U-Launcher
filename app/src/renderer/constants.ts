...
export const discordIcon = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='7' fill='%237289da'/%3E%3Ccircle cx='11' cy='12' r='3' fill='%23fff'/%3E%3Ccircle cx='21' cy='12' r='3' fill='%23fff'/%3E%3Cpath d='M9 22 Q16 26 23 22' stroke='%23fff' stroke-width='2' fill='none' stroke-linecap='round'/%3E%3C/svg%3E";

export const githubIcon = `data:image/svg+xml;utf8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
...
export const DONATION_URL = "https://ko-fi.com/praxa";

export const FLYFF_URL = "https://universe.flyff.com/play";

export const NEWS_BASE_URL = "https://universe.flyff.com";

export const STORAGE_THEME_KEY = "launcherTheme";

export const STORAGE_TAB_ACTIVE_KEY = "launcherTabActiveColor";
