...
- Отдельное окно в плагине Killfeed для отслеживания и визуализации статистики убийств Giants, Violets и Bosses.

### ✨ Улучшения
- Killfeed: в аккордеонах трекинга монстров теперь есть кнопка «Kills» по каждому рангу со списком отдельных киллов.
- Killfeed: отдельные киллы теперь можно удалять прямо из этого списка.

### 🐛 Исправления
- Killfeed: удаление отдельных киллов теперь стабильно обновляет файлы истории AppData (daily/YYYY-MM-DD.csv, history.csv) и состояние боковой панели.
