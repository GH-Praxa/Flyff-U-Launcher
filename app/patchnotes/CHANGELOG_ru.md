...
**Объявления лаунчера**
- Новый раздел в правой панели показывает сообщения от разработчика без обновления приложения
- Типы: 🐛 Ошибка, ℹ Инфо, ✨ Функция, ⚠ Предупреждение — каждый с отдельным цветом
- Полная локализация: сообщения можно переводить на все 8 поддерживаемых языков
- Можно отключить в Настройки → Настройки клиента → «Показывать объявления лаунчера»
- Открытые профили в правой панели теперь можно сворачивать
