...
(function() {
  ...
  // Localization - try multiple sources
  ...
  // Short badge labels for compact overlay display (translated)
  const BADGE_LABELS_I18N = {
    en: {
      killsSession: 'Kills',
      killsTotal: 'Total',
      killsPerHour: 'K/h',
    ...
    de: {
      ...
      expPerMin: 'E/m',
      currentExp: 'EXP',
      killsToLevel: 'Bis Lvl',
      sessionDuration: 'Zeit',
      expSession: 'Sess',
      avgTimePerKill: 'Ø',
      timeSinceLastKill: 'Idle',
      rmExp: 'RM EXP',
    ...
    fr: {
      ...
      expPerMin: 'E/m',
      currentExp: 'EXP',
      killsToLevel: 'Pour Niv',
      sessionDuration: 'Temps',
      expSession: 'Sess',
      avgTimePerKill: 'Moy',
      timeSinceLastKill: 'Idle',
      rmExp: 'RM EXP',
    ...
    jp: {
      ...
      expSession: 'セッション',
      avgTimePerKill: '平均',
      timeSinceLastKill: '待機',
      rmExp: 'RM EXP',
      last3Kills: '直近',
      resetSession: 'リセット'
    }
  };
  // Get labels for current locale (with fallback to English)
  function getBadgeLabels(loc) {
    return BADGE_LABELS_I18N[loc] || BADGE_LABELS_I18N.en;
  }
  let BADGE_LABELS = getBadgeLabels(currentLocale);
